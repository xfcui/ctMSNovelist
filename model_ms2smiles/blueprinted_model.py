...
from .components.decoder import SequenceDecoder
from .components.encoder import FingerprintFormulaEncoder
from .components.hydrogen_estimator import HydrogenEstimator
from .components.recurrent_additive import RecurrentAdditiveCell
from .components.sum_pooling import GlobalSumPooling
...
class BlueprintedModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = FingerprintFormulaEncoder(
            unit1=self.config["fp_enc_layers"][0],  # 512
            unit2=self.config["fp_enc_layers"][1],  # 256
            decoder_layers=self.config["decoder_layers"],  # 3
            fp_dim=3609,
            mf_dim=10
        )
